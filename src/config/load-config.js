...
export function loadConfig(env = {}) {
  ...
  return Object.freeze({
    ...
    userAgent: optionalString(env.DATA_USER_AGENT, 'Merlin/18.0 data-platform'),
    ...
    intelligence: Object.freeze({
      ...
      reliefWebAppName: optionalString(env.RELIEFWEB_APP_NAME, 'merlin'),
      ...
      reliefWebDisastersEnabled: booleanValue(env.RELIEFWEB_DISASTERS_ENABLED, true),
