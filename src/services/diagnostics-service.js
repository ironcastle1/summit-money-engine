export class DiagnosticsService {
  ...
  snapshot() {
    ...
    return {
      ...
      capabilities: ['MAP', 'RADIUS', 'NEWS', 'SOCIAL', 'VERIFICATION', 'CORRELATION', 'SHIPPING', 'PORTS', 'TRADE_FLOWS', 'COMMODITIES', 'COUNTRIES', 'CITIES', 'CRIME', 'ELECTIONS', 'SAFETY', 'CONFLICT', 'DISASTERS', 'MARKETS', 'PREDICTIONS', 'OPPORTUNITIES', 'ALERTS', 'REPLAY', 'WORKSPACES', 'EXPORT'],
