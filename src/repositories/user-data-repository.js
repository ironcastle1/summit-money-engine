const ALLOWED_BUCKETS = new Set(['watchlists', 'workspaces', 'alerts', 'savedSearches', 'preferences', 'savedViews']);
...
export class UserDataRepository {
    ...
    async removeUser(userId) { return this.store.update(doc => { const existed = Boolean(doc.userData?.[userId]); if (doc.userData)
        delete doc.userData[userId]; return existed; }); }
}
