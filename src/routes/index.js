...
export function registerRoutes(app,db){
  app.get('/api/health',(req,res)=>res.json({ok:true,system:'MERLIN',version:'9.3.0',domain:'cnc-business-os-deterministic',now:new Date().toISOString(),intake:'deterministic-parser',research:marketResearchStatus(db)}));
