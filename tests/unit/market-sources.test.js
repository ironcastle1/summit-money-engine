...
const crypto = normalizeAsset({ id: 'btc-usd', symbol: 'BTC', name: 'Bitcoin', assetClass: 'crypto', baseCurrency: 'BTC', quoteCurrency: 'USD', sources: { binance: { symbol: 'BTCUSDT' }, coingecko: { symbol: 'bitcoin' } } });
