...
const required = [
  'server.js', 'package.json', 'public/index.html', 'public/app.js', 'public/css/app.css',
  ...
  'public/manifest.webmanifest', 'public/sw.js', 'public/offline.html', 'public/assets/world-base.svg', 'public/assets/merlin-logo-master.png', 'public/assets/merlin-mark-white.png', 'public/icons/merlin-192.png', 'public/icons/merlin-512.png', 'public/css/premium.css', 'public/css/motion.css',
  'public/experience/preferences.js', 'public/experience/sound-library.js', 'public/experience/sound-engine.js',
  'public/experience/command-registry.js', 'public/experience/command-palette.js', 'public/experience/experience-controller.js', 'Dockerfile', '.github/workflows/ci.yml'
];
...
async function verifyInterface() {
  ...
  console.log(`Verified ${ids.length} HTML IDs and ${new Set(assetPaths).size} local entry assets.`);
}
