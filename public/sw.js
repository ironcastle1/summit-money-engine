const VERSION = '16.9.2-vector';
const SHELL_CACHE = `summit-shell-${VERSION}`;
const RUNTIME_CACHE = `summit-runtime-${VERSION}`;
const MAP_CACHE = `summit-map-${VERSION}`;
const SHELL = [
  '/', '/index.html', '/app.bundle.js', '/css/app.css', '/css/tokens.css', '/css/layout.css', '/css/components.css', '/css/panel.css',
  '/css/map.css', '/css/markets.css', '/css/news.css', '/css/shipping.css', '/css/intelligence.css', '/css/account.css', '/css/part3.css',
  '/css/ops.css', '/css/premium.css', '/css/motion.css', '/experience/preferences.js', '/experience/sound-library.js', '/experience/sound-engine.js', '/experience/command-registry.js', '/experience/command-palette.js', '/experience/experience-controller.js', '/offline.html', '/manifest.webmanifest', '/icons/summit-icon.svg', '/assets/world-base.svg'
];
