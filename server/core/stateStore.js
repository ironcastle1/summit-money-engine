...
const ACTIVE_WAR_OVERLAY = new Set(["Ukraine","Syria","Sudan","Yemen","Somalia","Mali","Burkina Faso","Niger","Myanmar","Palestine","Israel","Lebanon"]);
const CONFLICT_ZONES = [
  { id: "ukraine-east", name: "Ukraine active conflict belt", country: "Ukraine", type: "estimated conflict zone", lat: 48.7, lng: 37.7, radiusKm: 260, source: "public conflict reporting estimate" },
  { id: "gaza", name: "Gaza active conflict zone", country: "Palestine", type: "estimated conflict zone", lat: 31.50, lng: 34.46, radiusKm: 36, source: "public conflict reporting estimate" },
  { id: "israel-lebanon-border", name: "Israel/Lebanon border conflict zone", country: "Lebanon", type: "estimated conflict zone", lat: 33.18, lng: 35.55, radiusKm: 55, source: "public conflict reporting estimate" },
  { id: "syria-northwest", name: "Northwest Syria active conflict zone", country: "Syria", type: "estimated conflict zone", lat: 35.85, lng: 36.70, radiusKm: 115, source: "public conflict reporting estimate" },
  { id: "sudan-khartoum-darfur", name: "Sudan conflict zones", country: "Sudan", type: "estimated conflict zone", lat: 15.55, lng: 32.53, radiusKm: 170, source: "public conflict reporting estimate" },
  { id: "yemen", name: "Yemen conflict/security zone", country: "Yemen", type: "estimated conflict zone", lat: 15.35, lng: 44.20, radiusKm: 210, source: "public conflict reporting estimate" },
  { id: "somalia", name: "Somalia active security zone", country: "Somalia", type: "estimated conflict zone", lat: 2.05, lng: 45.32, radiusKm: 180, source: "public security reporting estimate" },
  { id: "sahel", name: "Central Sahel insurgency risk belt", country: "Mali", type: "estimated conflict zone", lat: 14.3, lng: -1.0, radiusKm: 360, source: "public security reporting estimate" }
];
